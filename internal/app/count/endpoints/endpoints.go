...
func New(svc service.CountService, logger log.Logger, otTracer stdopentracing.Tracer, zipkinTracer *stdzipkin.Tracer) (ep Endpoints) {
...
func MakeTicEndpoint(svc service.CountService) (ep endpoint.Endpoint) {
...
// Primarily useful in a server.
func MakeTacEndpoint(svc service.CountService) (ep endpoint.Endpoint) {
	return func(ctx context.Context, _ interface{}) (interface{}, error) {
		res, err := svc.Tac(ctx)
