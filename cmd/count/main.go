...
import (
	...
	"github.com/cage1016/ms-sample/internal/app/count/postgres"
	"github.com/cage1016/ms-sample/internal/app/count/service"
	transportsgrpc "github.com/cage1016/ms-sample/internal/app/count/transports/grpc"
	transportshttp "github.com/cage1016/ms-sample/internal/app/count/transports/http"
...
const (
	...
	defHTTPPort      string = "9190"
	defGRPCPort      string = "9191"
	defDBHost               = "localhost"
	defDBPort               = "5432"
	defDBUser               = "postgres"
	defDBPass               = "password"
...
func NewServer(db *sqlx.DB, logger log.Logger) service.CountService {
...
func startGRPCServer(ctx context.Context, wg *sync.WaitGroup, endpoints endpoints.Endpoints, tracer stdopentracing.Tracer, zipkinTracer *zipkin.Tracer, port string, hs *health.Server, logger log.Logger) {
	...
	pb.RegisterCountServer(server, transportsgrpc.MakeGRPCServer(endpoints, tracer, zipkinTracer, logger))
