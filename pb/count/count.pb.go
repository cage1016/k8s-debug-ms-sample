...
func (*TacRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bdc4a427207cbe48, []int{2}
}
...
func (*TacResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bdc4a427207cbe48, []int{3}
}
...
var fileDescriptor_bdc4a427207cbe48 = []byte{
	...
	,
}
...
func (c *countClient) Tic(ctx context.Context, in *TicRequest, opts ...grpc.CallOption) (*TicResponse, error) {
	out := new(TicResponse)
	err := c.cc.Invoke(ctx, "/pb.Count/Tic", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *countClient) Tac(ctx context.Context, in *TacRequest, opts ...grpc.CallOption) (*TacResponse, error) {
	out := new(TacResponse)
	err := c.cc.Invoke(ctx, "/pb.Count/Tac", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCountServer can be embedded to have forward compatible implementations.
type UnimplementedCountServer struct {
}

func (*UnimplementedCountServer) Tic(ctx context.Context, req *TicRequest) (*TicResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Tic not implemented")
}
func (*UnimplementedCountServer) Tac(ctx context.Context, req *TacRequest) (*TacResponse, error) {
...
func _Count_Tic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TicRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CountServer).Tic(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Count/Tic",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CountServer).Tic(ctx, req.(*TicRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Count_Tac_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TacRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CountServer).Tac(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Count/Tac",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CountServer).Tac(ctx, req.(*TacRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _Count_serviceDesc = grpc.ServiceDesc{
	ServiceName: "pb.Count",
	HandlerType: (*CountServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Tic",
			Handler:    _Count_Tic_Handler,
		},
		{
			MethodName: "Tac",
			Handler:    _Count_Tac_Handler,
		},
	},
